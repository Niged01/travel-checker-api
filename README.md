...
- React Front end [repository](https://github.com/Niged01/travelled)
- [Development board](https://github.com/users/Niged01/projects/5/views/2?layout=board)
- [User Story board]()  tbc 
...
Travelled is for avid travellers to come together and share their travels so far on this wonderful planet of ours. Travellers can keep upto date with their travel buddies
and new travel buddies connecting in this community.

This is the backend repository for the application using the Django REST Framework(DRF) holding the API database for the front end part of the application.
...
## Bugs
### fixed
- When setting up the travelled view it would not render I kept getting comment not defined, I realised after some time that the serializers fields were incorrect as for this 
project I am not attaching comments to this section. 
...
## Credits
- The code institute walkthrough DRF_API project I used as a guide through this project, code is credited with modifications to suit my project, with additional models, serializers and views being made for the Travelled app in my front end react project.

## Acknowledgements
- The Code institute for the walkthrough project giving me inspiration.
- The slack community.
- The tutor support at The Code insitute. 
